...
// Version     :
// Copyright   :
// Description : Program used to demonstrate the motion blurring for images
...
void Process(int pos, int Ns,
  ...
  if (imgi.channels() != 1) {
    ...
    BlurrPBCsv(imgc1, imgc1d, Ns, angularVelocityIntegrator, capture_timestamp,
               time_exposure, time_readout, time_delay);
    BlurrPBCsv(imgc2, imgc2d, Ns, angularVelocityIntegrator, capture_timestamp,
               time_exposure, time_readout, time_delay);
    BlurrPBCsv(imgc3, imgc3d, Ns, angularVelocityIntegrator, capture_timestamp,
               time_exposure, time_readout, time_delay);
