...
int main(int argc, char* argv[]) {
  ...
  samples::addSamplesDataSearchSubDirectory(
      "doc/tutorials/imgproc/out_of_focus_deblur_filter/images");
...
void help() {
  ...
  cout << "DeBlur_v8" << endl;
  cout << "You will learn how to recover an out-of-focus image by Wiener filter"
       << endl;
}
