...
int main(int argc, char *argv[]) {
  ...
  */
  ...
  if (argc > 3) {
    ...
    switch (argv[2][0]) {
      case 's':
        std::cout << "Add salt and pepper noise\n";
        SPnoise(imgb, stdev);
        break;
      case 'g':
        std::cout << "Add gauss noise\n";
        Gnoise(imgb, 0.0, stdev);
        break;
      case 'p':
        std::cout << "Add poisson noise\n";
        Pnoise(imgb, stdev * 500);
        break;
      case 'e':
        std::cout << "Add speckle noise\n";
        SPEnoise(imgb, stdev);
        break;
      case 'u':
        std::cout << "Add uniform noise\n";
        Unoise(imgb, 1.00, stdev);
        break;
      default:
        std::cout << "No noise added\n";
    }
