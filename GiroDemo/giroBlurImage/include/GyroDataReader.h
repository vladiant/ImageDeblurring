...
class GyroDataReader {
 public:
  ...
  int readDataFromJPEGFile(const std::string& fileName);
  ...
  /**
   * @brief Calculates the number of gyro data samples for the given time
   * interval.
   */
  unsigned int calcNumberOfGyroSamplesInTimeInterval(Time startTime,
                                                     Time endTime);
  ...
  /**
   * @brief Fills the angular velocities during time interval in supplied
   * buffers.
   *
   * If any of the buffers is set to NULL, it will not be filled.
   *
   * @param startTime Time interval start in Time units.
   * @param endTime Time interval end in Time units.
   * @param timestamp Pointer to allocated buffer for the timestamps.
   * @param wX Pointer to allocated buffer for the X component of angular
   * velocity.
   * @param wY Pointer to allocated buffer for the Y component of angular
   ...
   * velocity.
   */
  void getAngularVelocitiesInInterval(Time startTime, Time endTime,
                                      Time* timeStamp, float* wX, float* wY,
                                      float* wZ);

  // TODO : Complete documentation.
  void getAngularValuesInInterval(
 ...
 private:
  ...
  Test::OpticalFlow::DiscreteAngularVelocitiesIntegrator<
      Test::Math::Versor<float>, float>* pAngularVelocityIntegrator;
  ...
  Test::OpticalFlow::GyroDataCorrection<float>* pGyroCorrector;
  ...
  void calcAngularVelocity(
      Test::OpticalFlow::GyroDataCorrection<float>& gyroCorrector,
      Test::OpticalFlow::GyroDataCorrection<float>::GyroSample_t gyroSample);
