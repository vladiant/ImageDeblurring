...
TvIterationRegularizer::TvIterationRegularizer(int imageWidth, int imageHeight)
...
TvIterationRegularizer::~TvIterationRegularizer() { deinit(); }

size_t TvIterationRegularizer::getMemorySize(int imageWidth, int imageHeight) {
...
void TvIterationRegularizer::init(int imageWidth, int imageHeight,
                                  void* pExternalMemory) {
...
void TvIterationRegularizer::deinit() {
  if (!isExternalMemoryUsed) {
    delete[] mIrlsWeights;
...
void TvIterationRegularizer::calculateRegularization(
...
void TvIterationRegularizer::calculateRegularizationX(
    const point_value_t* inputImageData, point_value_t* outputImageData,
    bool transposeKernel) {
...
void TvIterationRegularizer::calculateRegularizationY(
    const point_value_t* inputImageData, point_value_t* outputImageData,
    bool transposeKernel) {
...
void TvIterationRegularizer::calculateIrlsWeights(
...
void TvIterationRegularizer::calculateIrlsWeightsX(
    const point_value_t* inputImageData) {
...
void TvIterationRegularizer::calculateIrlsWeightsY(
    const point_value_t* inputImageData) {
  const float cUpLeft = -3.0;
