...
void vanCittertDeblurrer::doIterations(const SparseBlurKernel* blurKernels,
                                       int blurKernelsCount) {
  mProcessStatus = CONVERGENCE_OK;
  ...
  do {
    blur(mCurrentDeblurredImage, blurKernels, blurKernelsCount, mReblurredImage,
         false);
    ...
    blur(mResidualImage, blurKernels, blurKernelsCount, mReblurredImage, true);
...
void vanCittertDeblurrer::prepareIterations(const SparseBlurKernel* blurKernels,
                                            int blurKernelsCount) {
  size_t imageBlockSize = mImageWidth * mImageHeight * sizeof(point_value_t);
