...
#ifndef ITERATIVEDEBLURRER_LRTVDEBLURRER_H_
#define ITERATIVEDEBLURRER_LRTVDEBLURRER_H_
...
class LrTvDeblurrer : public IterativeDeblurrer {
 public:
  LrTvDeblurrer(int imageWidth, int imageHeight);

  LrTvDeblurrer(int imageWidth, int imageHeight, void* pExternalMemory);

  virtual ~LrTvDeblurrer();
 ...
 private:
  ...
  LrTvDeblurrer(const LrTvDeblurrer& other);
  LrTvDeblurrer& operator=(const LrTvDeblurrer& other);
...
#endif /* ITERATIVEDEBLURRER_LRTVDEBLURRER_H_ */
