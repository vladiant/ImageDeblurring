/*
 * GradientsIterationRegularizer.h
 *
 *  Created on: Jan 27, 2015
 *      Author: vantonov
 */

#ifndef ITERATIVEDEBLURRER_GRADIENTSITERATIONREGULARIZER_H_
#define ITERATIVEDEBLURRER_GRADIENTSITERATIONREGULARIZER_H_
...
class GradientsIterationRegularizer : public Deblurring::IterationRegularizer {
 public:
  GradientsIterationRegularizer(int imageWidth, int imageHeight);

  GradientsIterationRegularizer(int imageWidth, int imageHeight,
                                void* pExternalMemory);

  virtual ~GradientsIterationRegularizer();
...
#endif /* ITERATIVEDEBLURRER_GRADIENTSITERATIONREGULARIZER_H_ */
