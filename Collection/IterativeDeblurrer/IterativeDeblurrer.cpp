...
void IterativeDeblurrer::imposeContinuousBorder(
    point_coord_t& coordX, point_coord_t& coordY,
    [[maybe_unused]] point_value_t& kernelValue) {
...
void IterativeDeblurrer::imposePeriodicBorder(
    point_coord_t& coordX, point_coord_t& coordY,
    [[maybe_unused]] point_value_t& kernelValue) {
  int maxCoordX = mImageWidth - 1;
  int maxCoordY = mImageHeight - 1;
...
void IterativeDeblurrer::imposeMirrorBorder(
    point_coord_t& coordX, point_coord_t& coordY,
    [[maybe_unused]] point_value_t& kernelValue) {
  int maxCoordX = mImageWidth - 1;
  int maxCoordY = mImageHeight - 1;
